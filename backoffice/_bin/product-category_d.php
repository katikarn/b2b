...
/////////////////////////////////////////////////////////
	...
	$page_nav["Product"]["sub"]["Product Category"]["sub"]["[3] Day Trip"]["active"] = true;
	include ("inc/nav.php");
?>
<style>
	.header{
						        ...
						        <table id="dt_basic" class="table table-striped table-bordered table-hover" style="margin-top:0px" width="100%">
									<thead>			                
										<tr class="header">
											...
											<th data-hide="phone">Short Detail</th>
									...
									<tbody>
										<?PHP
											$sql = "SELECT product_id, product_status, product_name, product_seat, product_desc, product_detail,
											...
											if(mysqli_num_rows($result) > 0){
												...
												<tr>
													...
													<td><?=$row['product_name']?><?php if ($row['product_remark']<>"")	{?> 
													...
													<td><?=$row['product_desc']?><?php 
														if ($row['product_detail']<>"")	{?> 
															<i class="fa fa-info-circle" title="<?=$row['product_detail']?>"></i>
														<?php }?></td>

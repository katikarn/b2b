								...
								<form action="shopping-info-controller.php" method="post" id="contact-form" class="smart-form">
											...
											<div class="form-bootstrapWizard">
												<ul class="bootstrapWizard form-wizard">
													...
													<li data-target="#step2">
														<a href="shopping-info.php"> <span class="step">2</span> <span class="title">Guest Info</span> </a>
													</li>
									...
									<footer>
										...
										<section class="col col-2">
											...
											<input type="hidden" name="hAction" id="hAction" value="Up_Submit">
											<div class="col-xs-2 col-md-2">
												<label class="checkbox">
													<input type="checkbox" name="conf" id="conf" value="Confirm" onclick="ConfirmCheckbox();"><i></i><span style="background-color: white">Confirmation</span>
												</label>
											</div>													
											<button type="submit" class="btn btn-primary" name="submitAddBooking" id="submitAddBooking" disabled="disabled">Next</button>
										</section>
									</footer>
								</form>
							</div>

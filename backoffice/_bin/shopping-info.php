<?php 
	...
	if ($agent_id<>"")	{
		...
		if ($row['m_bid']>0)	{
			...
			header("location: product-category_a.php");
		}
	}else{
		header("location: product-category_a.php");
	}
							...
							<div class="widget-body no-padding">
								<form action="shopping-info-controller.php" method="post" id="contact-form" class="smart-form">
									...
									<fieldset>
											...
											<div class="form-bootstrapWizard">
												<ul class="bootstrapWizard form-wizard">
													<li data-target="#step1">
														<a href="product-category_a.php"> <span class="step">1</span> <span class="title">Add product</span> </a>
													</li>
													<li class="active" data-target="#step2">
														<span class="step">2</span> <span class="title">Guest Info</span>
													</li>
													<li data-target="#step3">
														<a href="shopping-info-review.php"> <span class="step">3</span> <span class="title">Review</span> </a>
													</li>
										...
										<div class="row">
										<section><label class="label">&nbsp;</label></section>
										</div>
										<div class="row">
									...
									<footer>
										...
										<section class="col col-4">
											...
											<input type="hidden" name="hAction" id="hAction" value="Up_B">
											<button type="submit" class="btn btn-primary" name="submitAddBooking" id="submitAddBooking">Next</button>
										</section>
									</footer>
								</form>
							</div>
												...
												<tr class="header">
													...
													<th>
														<div style="text-align: center">
															<a href="product-category_a.php" class="btn btn-primary bg-color-green"><i style="margin-right: 10px;" class="icon-append fa fa-plus"></i> Add new </a>
														</div>
													</th>
												</tr>
											</thead>
											<tbody>
												...
												<tr>
													...
													<td class="center"><a onclick="resetModal();" class="btn btn-small btn-primary bg-color-green"
															...
															<a href="shopping-info-controller.php?booking_detail_id=<?=$row['booking_detail_id']?>&hAction=Del_P" class="btn btn-small btn-danger">Del</a>
													</td>
												</tr>
												<?PHP }}?>
											</tbody>
...
<script type="text/javascript">
	...
	var errorClass = 'invalid';
		...
		var $contactForm = $("#contact-form").validate({
		    ...
		    submitHandler : function(form) {
		      if (confirm("Do you want go to 3.Review ?")) {
		        form.submit();
		      }
		    },
		// Rules for form validation

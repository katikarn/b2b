												...
												while($row = mysqli_fetch_assoc($result))	{?>
													<tr>
														...
														<td class="center"><a onclick="resetModal();" class="btn btn-small btn-success"
															data-toggle="modal"
															data-target="#myModal"
															data-whatever="<?=$row['currency_id']?>" ><i class="fa fa-pencil"></i> <span class="hidden-mobile">Edit</span></a>
															<a href="mas-currency-controller.php?id=<?=$row['currency_id']?>&hAction=Delete" class="btn btn-small btn-danger"><i class="fa fa-trash-o"></i> <span class="hidden-mobile">Del</span></a>
														</td>
													</tr>
												<?PHP
												}
